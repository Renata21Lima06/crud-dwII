document
    ...
    .addEventListener("click", () => clienteDados("POST"));
document
    .getElementById("buscar")
    .addEventListener("click", () => clienteDados("GET"));
document
    .getElementById("alterar")
    .addEventListener("click", () => clienteDados("PUT"));
document
    .getElementById("apagar")
    .addEventListener("click", () => clienteDados("DELETE"));
